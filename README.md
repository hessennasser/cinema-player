...
- Lets you choose embedded subtitle tracks or load external SubRip (`.srt`) and WebVTT (`.vtt`) files, with a simple subtitle timing adjustment; a file that is not UTF-8 is still read
